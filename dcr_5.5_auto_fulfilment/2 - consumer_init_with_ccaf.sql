...
//cleanup//
show shares;
--select $4 as name from table(result_scan(last_query_id())) where $5 = 'DCR_samp_CONSUMER';
...
-- SET SHARE_VAR = (select $2 as global_name from table(result_scan(last_query_id())) where "title" ilike '%dcr_samp_app%');
